...
if(alendif > 0){ tem= Img.addRight(tem, alendif/2); tem=Img.addLeft(tem, alendif-alendif/2); }
  else{ a = Img.addRight(a, -alendif/2); tem=Img.addLeft(tem, alendif/2-alendif); }
if(aglendif > 0){ tem= Img.addDown(tem, aglendif/2); tem=Img.addLeft(tem, aglendif-aglendif/2);  }
  else{ a = Img.addDown(a, -aglendif/2); tem=Img.addLeft(tem, aglendif/2-aglendif);}
